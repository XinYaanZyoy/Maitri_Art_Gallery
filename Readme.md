...
- ONE TIME
    ...
    4. push to your personal repo
    5. create and copy a token from [here](https://github.com/settings/tokens)
    6. paste it in the secrets of your repo (you find it in the repo specific settings) and name it GH_PAT

- EVERY TIME
    7. upload an art in arts directory
    8. the entrier flow will automatically entry your art in your website
    9. [optional] done! checkout the output! on the url your_github_username.github.io/your_repo_name
    10. [optional] edit _arts/[your art file name].md file for adding captions!
    11. [optional] done! checkout the output! on the url your_github_username.github.io/your_repo_name

- SOME TIMES
    12. if you delete an art from arts directory the entrier flow will automatically de-entry your art from your website
    13. [optional] done! checkout the output! on the url your_github_username.github.io/your_repo_name
--------
